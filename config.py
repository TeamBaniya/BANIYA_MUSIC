...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/TeamBaniya/BANIYA_MUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BANIYA_BOTS")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/BANIYA_UPDATES")
